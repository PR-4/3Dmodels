...
# read .txt as lines
with open("../Gempy_3.0/surface_points.txt") as f:
    lines = f.readlines()
...
df.info()
df.describe()
df.to_csv("../Gempy_3.0/surface_points_full_crono.csv", index=False)
...
# Salvar em csv
df.to_csv("../Gempy_3.0/surface_points_full_crono_scaled.csv", index=False)
