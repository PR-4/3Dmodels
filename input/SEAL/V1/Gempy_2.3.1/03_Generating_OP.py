...
path_processed = "../Gempy_2.3.1/surface_points_less_crono_scaled.csv"

# Carregue seus dados
surface_points_df = pd.read_csv(path_processed)
...
topo_surface_points = surface_points_df[surface_points_df["formation"] == "EOC-SUP"]
