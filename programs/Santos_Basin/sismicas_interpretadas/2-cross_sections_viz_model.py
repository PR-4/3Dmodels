...
model = "Santos-Inter-Sismicas-1.nc"
model_n = os.path.splitext(model)[0]
path_model = "../../../output/Santos_Basin/sismicas_interpretadas/horizontes_interpolados/"
...
idx1 = pos1 = 49  # substitua pelo valor que quiser plotar (resolução do modelo, nesse caso de 0 a 100)
ypos1 = y[pos1]
xpos1 = x[pos1]
zpos1 = z[pos1]
...
model_pkl = "Santos-Inter-Sismicas-1"
# Loading the model
...
surface_path = "../../../output/Santos_Basin/sismicas_interpretadas/horizontes_interpolados/Santos-Inter-Sismicas-1_results/csv_results/"
path_model = "../../../output/Santos_Basin/sismicas_interpretadas/horizontes_interpolados/Santos-Inter-Sismicas-1_results/triangulated_surfaces/"
...
# Loop through all the files
for i in range(2):  # assuming you have files from 0 to 12
    # Read the vertices and edges from the csv files
    vertices = pd.read_csv(os.path.join(path_model, f"vertices_id-{i}.csv")).values
    edges = pd.read_csv(os.path.join(path_model, f"edges_id-{i}.csv")).values
